...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function commentHtmlGenerator(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (_id, articleID, downVoteCount, name, text, upVoteCount) {;pug_debug_line = 1;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Carticle" + (" class=\"comment\""+pug_attr("data-id", _id, true, false)+pug_attr("data-article-id", articleID, true, false)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv class=\"create\" style=\"display: none;\"\u003E";
;pug_debug_line = 14;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cinput class=\"name\" type=\"text\" placeholder=\"Name...\"\u002F\u003E";
;pug_debug_line = 15;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cinput class=\"text\" type=\"text\" placeholder=\"Text...\"\u002F\u003E";
;pug_debug_line = 16;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cbutton class=\"submit\"\u003E";
;pug_debug_line = 16;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Submit\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Ffooter\u003E\u003C\u002Farticle\u003E";}.call(this,"_id" in locals_for_with?locals_for_with._id:typeof _id!=="undefined"?_id:undefined,"articleID" in locals_for_with?locals_for_with.articleID:typeof articleID!=="undefined"?articleID:undefined,"downVoteCount" in locals_for_with?locals_for_with.downVoteCount:typeof downVoteCount!=="undefined"?downVoteCount:undefined,"name" in locals_for_with?locals_for_with.name:typeof name!=="undefined"?name:undefined,"text" in locals_for_with?locals_for_with.text:typeof text!=="undefined"?text:undefined,"upVoteCount" in locals_for_with?locals_for_with.upVoteCount:typeof upVoteCount!=="undefined"?upVoteCount:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}