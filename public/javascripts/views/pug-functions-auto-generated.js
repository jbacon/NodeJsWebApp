...
function pug_escape(e){var a=""+e,t=pug_match_html.exec(a);if(!t)return e;var r,c,n,s="";for(r=t.index,c=0;r<a.length;r++){switch(a.charCodeAt(r)){case 34:n="&quot;";break;case 38:n="&amp;";break;case 60:n="&lt;";break;case 62:n="&gt;";break;default:continue}c!==r&&(s+=a.substring(c,r)),c=r+1,s+=n}return c!==r?s+a.substring(c,r):s}
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function generatehtmlforcomment(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (_id, comment) {;pug_debug_line = 1;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Carticle" + (" class=\"comment\""+pug_attr("data-id", _id, true, false)+pug_attr("data-account-id", comment.accountID, true, false)+pug_attr("data-article-id", comment.articleID, true, false)+pug_attr("data-parent-comment-id", comment.parentCommentID, true, false)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv class=\"load-more hidden\"\u003E";
;pug_debug_line = 12;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
...
;pug_debug_line = 18;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Submit\u003C\u002Fbutton\u003E\u003C\u002Fform\u003E\u003C\u002Ffooter\u003E\u003C\u002Farticle\u003E";}.call(this,"_id" in locals_for_with?locals_for_with._id:typeof _id!=="undefined"?_id:undefined,"comment" in locals_for_with?locals_for_with.comment:typeof comment!=="undefined"?comment:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}
