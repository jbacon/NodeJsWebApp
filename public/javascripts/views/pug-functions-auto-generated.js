...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function generatehtmlforcomment(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (authorizedDelete, authorizedRemove, authorizedVote, comment) {;pug_debug_line = 1;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
var commentDisabled = comment.removed || comment.flags > 5
...
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 3;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = (comment.removed || commentDisabled) ? '~~Comment has been Removed~~' : comment.text) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
...
pug_html = pug_html + "\u003Cspan class=\"replies-toggle clickable\"\u003E";
;pug_debug_line = 6;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Show Replies\u003C\u002Fspan\u003E";
;pug_debug_line = 7;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["up-vote-count",(authorizedVote && !commentDisabled) ? '' : 'hidden'], [false,true]), false, false)) + "\u003E";
;pug_debug_line = 7;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
...
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["up-vote","clickable",(authorizedVote && !commentDisabled) ? '' : 'hidden'], [false,false,true]), false, false)) + "\u003E";
;pug_debug_line = 8;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Up\u003C\u002Fspan\u003E";
;pug_debug_line = 9;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["down-vote-count",(authorizedVote && !commentDisabled) ? '' : 'hidden'], [false,true]), false, false)) + "\u003E";
;pug_debug_line = 9;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
...
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["down-vote","clickable",(authorizedVote && !commentDisabled) ? '' : 'hidden'], [false,false,true]), false, false)) + "\u003E";
;pug_debug_line = 10;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Down\u003C\u002Fspan\u003E";
;pug_debug_line = 11;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["delete","clickable",(authorizedDelete && !commentDisabled) ? '' : 'hidden'], [false,false,true]), false, false)) + "\u003E";
;pug_debug_line = 11;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Delete\u003C\u002Fspan\u003E";
;pug_debug_line = 12;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["remove","clickable",(authorizedRemove && !commentDisabled) ? '' : 'hidden'], [false,false,true]), false, false)) + "\u003E";
;pug_debug_line = 12;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Remove\u003C\u002Fspan\u003E";
;pug_debug_line = 13;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["flag","clickable",(authorizedVote && !commentDisabled) ? '' : 'hidden'], [false,false,true]), false, false)) + "\u003E";
;pug_debug_line = 13;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Flag\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 14;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cdiv class=\"load-newer clickable hidden\"\u003E";
;pug_debug_line = 14;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
...
pug_html = pug_html + "\u003Cdiv class=\"load-older cwlickable hidden\"\u003E";
;pug_debug_line = 16;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Load Older...\u003C\u002Fdiv\u003E";
;pug_debug_line = 17;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cdiv class=\"reply-toggle clickable hidden\"\u003E";
;pug_debug_line = 17;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
...
;pug_debug_line = 22;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Submit\u003C\u002Fbutton\u003E\u003C\u002Fform\u003E\u003C\u002Ffooter\u003E\u003C\u002Farticle\u003E";}.call(this,"authorizedDelete" in locals_for_with?locals_for_with.authorizedDelete:typeof authorizedDelete!=="undefined"?authorizedDelete:undefined,"authorizedRemove" in locals_for_with?locals_for_with.authorizedRemove:typeof authorizedRemove!=="undefined"?authorizedRemove:undefined,"authorizedVote" in locals_for_with?locals_for_with.authorizedVote:typeof authorizedVote!=="undefined"?authorizedVote:undefined,"comment" in locals_for_with?locals_for_with.comment:typeof comment!=="undefined"?comment:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}
