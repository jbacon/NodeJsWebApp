...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function generatehtmlforcomment(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (authorizedCreate, authorizedDelete, authorizedRemove, comment) {;pug_debug_line = 1;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
...
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 2;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = (comment.removed || comment.flags > 5) ? '~~Comment has been Removed~~' : comment.text) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
...
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["delete",authorizedDelete ? '' : 'hidden'], [false,true]), false, false)) + "\u003E";
;pug_debug_line = 10;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Delete\u003C\u002Fspan\u003E";
;pug_debug_line = 11;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(["remove",authorizedRemove ? '' : 'hidden'], [false,true]), false, false)) + "\u003E";
;pug_debug_line = 11;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "Remove\u003C\u002Fspan\u003E";
;pug_debug_line = 12;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
pug_html = pug_html + "\u003Cspan class=\"flag\"\u003E";
;pug_debug_line = 12;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["reply-toggle",authorizedCreate ? '' : 'hidden'], [false,true]), false, false)) + "\u003E";
;pug_debug_line = 17;pug_debug_filename = ".\u002Fviews\u002Fclient\u002Fcomment.pug";
